...
const datasetProvider = new DatasetsProvider(await dataset.prepareData('generated-credit-memos-for-invoices-marked-pending-as-of-26th-08-2025.json') as TaxItemHeader[]);
