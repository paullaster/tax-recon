...
// --- Usage Example ---
const excelFilePath = 'April 2025 Auto populated CRN by Kinetics (1).xlsx'; // Replace with your Excel file path
...
const outputFilePath = 'extracted_cu_inv.json'; // <--- Specify your desired output file path here
